            ...
            <Card className="glass-card animate-fade-in-up animate-delay-5">
                ...
                <CardContent>
                    <p className="text-sm text-muted-foreground">
                        No staking data available. Stake information is fetched from vote accounts.
                    </p>
                </CardContent>
            </Card>
        );
            ...
            <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                        ...
                        <span>Network: {formatStake(totalStake)} XAND</span>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
                ...
                {nodes.filter((n) => n.stake).length > 10 && (
                    <p className="text-xs text-muted-foreground text-center mt-3">
                        +{nodes.filter((n) => n.stake).length - 10} more staked nodes
                    </p>
                )}
            </CardContent>
        </Card>
